...
Download the Acropora digitifera protein + transcript sequences 
...
wget https://github.com/sujaikumar/assemblage/raw/master/fastaqual_select.pl

```

Run Repeat Masker. The TE database created by the previous repeat modeler run is typically not comprehensive, so I am running a couple extra stesp 
```
